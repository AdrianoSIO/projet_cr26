...
<div class="d-flex justify-content-center align-items-center py-3" style="background-color: #232323; border-color: rgb(206, 0, 0); color: #fff;">
  ...
  <?php if (empty($_SESSION['login'])): ?>
      <a href="../index.php" class="navbar-brand text-white mx-2" style="margin-right: 20px;">Connexion</a>
      <?php else: ?>
      <a href="../communication/deco.php" class="navbar-brand text-white mx-2" style="margin-right: 20px;">Déconnexion</a>
      <a href="../page/compte.php" class="navbar-brand text-white mx-2" style="margin-right: 20px;">Mot de passe</a>
  <?php endif; ?>
</div> 
...
<nav class="navbar" style="background-color: #c40000; min-height: 35px;">
  <div class="container d-flex justify-content-center align-items-center">
      ...
      <a href="../page/produit.php" class="navbar-brand text-white mx-2" style="margin-right: 20px;">Produit</a>
      <a href="../page/historique.php" class="navbar-brand text-white mx-2" style="margin-left: 20px;">Suivi</a>
      <a href="../page/mouvement.php" class="navbar-brand text-white mx-2" style="margin-left: 20px;">Mouvement</a>
  </div>
</nav>
